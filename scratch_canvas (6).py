side = int(input('type side'))
#Take the user input for side value
...
#write the variable name for corresponding,
#write the variable name for corresponding,
#write the variable name for corresponding)

radius = int(input('radius'))
#Take the user input for radius value
...
#write the variable name for corresponding,
#write the variable name for corresponding)
r=int(input('radius once again'))
area_cone = ((22 / 7) * side) * r
